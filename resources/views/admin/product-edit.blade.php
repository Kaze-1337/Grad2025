...
<div class="main-content-inner">
    ...
    <div class="main-content-wrap">
        ...
        <!-- form-edit-product -->
        <form class="tf-section-2 form-add-product" action="{{ route('admin.product.update', ['id' => $product->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="wg-box">
                ...
                <fieldset class="description">
                    ...
                    <div class="text-tiny">Enter a detailed description of the product.</div>
                </fieldset>
