...
<main class="pt-90">
    <section class="shop-main container d-flex pt-4 pt-xl-5">
            ...
            <div id="accordion-filter-brand" class="accordion-collapse collapse show border-0"
              ...
              <div class="search-field multi-select accordion-body px-0 pb-0">
                <ul class="list list-inline mb-0 brand-list">
                  ...
                  <li class="list-item">
                    <span class="menu-link py-1">
                      <input type="checkbox" name="brands" value="{{ $brand->id }}" class="chk-board"
                ...
                <div class="slide-split_text position-relative d-flex align-items-center"
                  ...
                  <div class="slideshow-text container p-3 p-xl-5">
                    <h2
                      ...
                      Nike's <br /><strong>Jordan 1</strong></h2>
                    <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Jordan 1 - A sneaker that represents the pinnacle of fashion, unparalleled quality, and undeniable charisma, empowering you to confidently showcase your unique style anytime, anywhere.</p>
                  </div>
                </div>
          ...
          <div class="product-card-wrapper">
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="background-img" style="height: 300px; display: flex; align-items: center; justify-content: center; background: #f5f5f5;">
                    <a href="{{ route('shop.product.details',['product_slug'=>$product->slug]) }}" style="width: 100%; height: 100%; display: flex; align-items: center; justify-content: center;">
                        <img loading="lazy" 
                ...
                <a href="{{ route('shop.product.details', ['product_slug' => $product->slug]) }}" class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium">Details</a>
              </div>
              ...
              <div class="pc__info position-relative">
                ...
                <form method="POST" action="{{ route('wishlist.item.remove',['rowId'=>Surfsidemedia\Shoppingcart\Facades\Cart::instance('wishlist')->content()->where('id', $product->id)->first()->rowId]) }}">
                  @csrf
                  @method('DELETE')
                  <button type="submit" class="pc__btn-wl position-absolute top-0 end-0 bg-transparent border-0 js-add-wishlist filled-heart" title="Remove form Wishlist">
      ...
      <div class="flex item-center justify-between flex-wrap gap10 wpg-pagination">
